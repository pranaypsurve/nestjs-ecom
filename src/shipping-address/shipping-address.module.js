...
exports.ShippingAddressModule = ShippingAddressModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([shipping_address_entity_1.ShippingAddress]), auth_module_1.AuthModule],
        ...
        exports: [shipping_address_service_1.ShippingAddressService],
    })
